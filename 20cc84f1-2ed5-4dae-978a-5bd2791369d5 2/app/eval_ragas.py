...
"""Optional evaluation script using Ragas.

Expected dataset JSONL schema per line:
{
  "user_input": "question",
...
If retrieved_contexts/response are omitted, this script will run your RAG chain
and fill them in before evaluation.
"""
...
def main():
    ...
    # Fill missing response + retrieved contexts.
    prepared = []
    for r in rows:
        q = r["user_input"]
